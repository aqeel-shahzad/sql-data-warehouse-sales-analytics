/*
===============================================================================
Script Name: 05_transform_bronze_to_silver.sql
Purpose: Clean, standardise and load data from the Bronze layer into the Silver layer.

This script:
1. Truncates each Silver table before loading
2. Cleans and standardises CRM customer data
3. Cleans and standardises CRM product data
4. Cleans and standardises CRM sales data
5. Cleans and standardises ERP customer, location and product category data

Transformations include:
- Removing duplicate customer records
- Keeping the latest customer record
- Trimming unwanted spaces
- Standardising marital status and gender values
- Cleaning product category IDs and product keys
- Replacing missing product costs
- Standardising product line values
- Converting numeric date fields into DATE format
...
PRINT '-----------------------------------------';
PRINT 'Transforming CRM Customer Information';
PRINT '-----------------------------------------';
